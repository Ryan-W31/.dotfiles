		...
		java = {
			...
			configuration = {
				...
				runtimes = {
					{
						name = "JavaSE-11",
						path = "/Library/Java/JavaVirtualMachines/applejdk-11.0.26.4.1.jdk/Contents/Home",
					},
					{
						name = "JavaSE-17",
						path = "/Library/Java/JavaVirtualMachines/applejdk-17.0.1.12.1.jdk/Contents/Home",
					},
					{
						name = "JavaSE-21",
